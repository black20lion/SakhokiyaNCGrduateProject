...
public class CustomerService {
    ...
    public String getUserKeycloakIdByUsername(String email) {
        try {
            ...
            String request = "http://localhost:8180/admin/realms/shop/users?username=" + email;
            URL url = new URL(request);
            HttpURLConnection con = (HttpURLConnection) url.openConnection();
    ...
    public String setUserPassword(String password, String id) {
        try {
            ...
            int postDataLength = postData.length;
            String accessToken = getAccessToken();
            String request = "http://localhost:8180/admin/realms/shop/users/" + id + "/reset-password";
            URL url = new URL(request);
            HttpURLConnection con = (HttpURLConnection) url.openConnection();
            con.setInstanceFollowRedirects(false);
    ...
    public String deleteUserById(String id) {
        try {
            String accessToken = getAccessToken();
            String request = "http://localhost:8180/admin/realms/shop/users/" + id;
            URL url = new URL(request);
            HttpURLConnection con = (HttpURLConnection) url.openConnection();
    ...
    public String setUserRole(String id) {
        try {
            ...
            String request = "http://localhost:8180/admin/realms/shop/users/" + id + "/role-mappings/realm";
            URL url = new URL(request);
            HttpURLConnection con = (HttpURLConnection) url.openConnection();
            con.setInstanceFollowRedirects(false);
